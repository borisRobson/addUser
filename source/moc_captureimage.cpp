...
**
** Created: Tue Aug 16 10:52:11 2016
...
static const char qt_meta_stringdata_imageWriter[] = {
    "imageWriter\0\0exitCode,exitStatus\0"
...
void imageWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->imageSent((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData imageWriter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject imageWriter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_imageWriter,
      qt_meta_data_imageWriter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &imageWriter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_imageWriter))
